...
cap = cv2.VideoCapture('/Users/apurvaghare/My Files/Code/python/object detection/Main/traffic management/car22.mp4') 
...
# Define the coordinates for the 'Yellow Line' (e.g., a horizontal line at y=450)
# Format: (x1, y1, x2, y2)
# You will need to adjust these based on your video's resolution and perspective
yellow_line_y = 600 
...
while True:
    ...
    h, w, _ = img.shape
    line_start = (50, yellow_line_y)
    line_end = (w - 50, yellow_line_y)
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if conf > 0.5 and class_name in vehicle_classes:
                ...
                # Check if the center point is past the yellow line
                # (vehicle considered past the line when its center y coordinate
                # is above the line)
                if cy < yellow_line_y:
